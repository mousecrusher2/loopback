...
#[derive(Clone, Copy)]
pub(crate) enum InFallbackReason {
    QueueEmpty,
    FormatMismatch,
}
...
static UAC_DIAG_IN_FALLBACK_PACKETS: AtomicU32 = AtomicU32::new(0);
static UAC_DIAG_IN_FALLBACK_BYTES: AtomicU32 = AtomicU32::new(0);
static UAC_DIAG_IN_FALLBACK_LAST_REASON: AtomicU32 = AtomicU32::new(0);
...
pub(crate) fn add_in_fallback(reason: InFallbackReason, len: usize) {
...
pub(crate) fn in_fallback_packets() -> u32 {
